...
<body>
    ...
    <div id="appCapsule">
            ...
            <div class="wallet-card">
                ...
                <div class="balance">
                    <div class="left">
                        ...
                        <h1 class="total">Admin Dashboard</h1>
                    </div>
                    <div class="right">
                ...
                <div class="wallet-footer">
                    <div class="item">
                        <a href="database/produk/index.php">
                    ...
                    <div class="item">
                        <a href="database/kategori/index.php">
                    ...
                    <div class="item">
                        <a href="database/user/index.php">
                    ...
                    <div class="item">
                        <a href="database/produk/keranjang/tampil_keranjang.php">
                    ...
                    <div class="item">
                        <a href="database/produk/keranjang/riwayat.php">
        ...
        // include "include/transactions.php"; 
        // include "include/my card.php"; 
        // include "include/monthly.php"; 
        // include "include/goals.php"; 
        include "news.php";
        ?>
            ...
            <div class="modal-content">
                <div class="modal-body p-0">
                    ...
                    <div class="sidebar-balance">
                        <div class="listview-title">Profile</div>
                        <div class="in">
                            <h1 class="amount">
                                <?php
                    ...
                    <div class="action-group">
                        <?php if (isset($_SESSION['user'])): ?>
                            ...
                            <a href="send.php" class="action-button">
                                <div class="in">
                                    <div class="iconbox">
